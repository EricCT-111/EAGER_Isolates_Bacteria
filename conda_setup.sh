...
# Why: 
#  The shared module (miniconda/311_23.11.0-2) is out of date
...
bash Miniforge3-Linux-x86_64.sh -b -p /path/miniforge3
rm Miniforge3-Linux-x86_64.sh

# 2. Put it ahead of the hpc conda
echo 'export PATH="/path/miniforge3/condabin:$PATH"' >> ~/.bashrc
source ~/.bashrc
